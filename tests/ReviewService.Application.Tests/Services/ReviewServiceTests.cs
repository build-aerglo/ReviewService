...
public class ReviewServiceTests
{
    ...
    public async Task CreateReview_ShouldReturnResponse_WhenSuccessful_RegisteredUser()
    {
        ...
        // TODO: Enable when UserService implements UserExistsAsync
        // _mockUserServiceClient.Setup(c => c.UserExistsAsync(reviewerId)).ReturnsAsync(true);
        ...
        // TODO: Enable when UserService implements UserExistsAsync
        // _mockUserServiceClient.Verify(c => c.UserExistsAsync(reviewerId), Times.Once);
    ...
    public async Task CreateReview_WithLocation_ShouldSucceed()
    {
        ...
        _mockBusinessServiceClient.Setup(c => c.BusinessExistsAsync(businessId)).ReturnsAsync(true);
        // TODO: Enable when LocationService implements LocationExistsAsync
        // _mockLocationServiceClient.Setup(c => c.LocationExistsAsync(locationId)).ReturnsAsync(true);
        ...
        // TODO: Enable when LocationService implements LocationExistsAsync
        // _mockLocationServiceClient.Verify(c => c.LocationExistsAsync(locationId), Times.Once);
    }
